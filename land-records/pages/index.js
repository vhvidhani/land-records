        ...
        for(var i =0;i<this.props.lands.length;i++) {
            ...
            items.push({
                ...
                meta: (<p>Hash Address : {this.props.lands[i]}  <br/> Area : {this.props.areas1[i]} sq. m. <br/>
                    Price:{this.props.prices1[i]} <br/>Token Amt: {this.props.tokens1[i]}</p>),
                // meta: this.props.locs[i][0]+" "+this.props.locs[i][1],
                description:(<p><Link route={`/owner/${this.props.lands[i]}`}>
                <Button><a>Put for Sale</a></Button></Link>
                <Link route={`/buyer/${this.props.lands[i]}`}><Button><a>Get Buyers</a></Button></Link> </p>),
...
render(){
 ...
 <Card.Description><h4>Aadhar No : {this.props.ownadhr}</h4></Card.Description>
